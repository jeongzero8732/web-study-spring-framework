	...
	<body>
		...
		<div id="wrap">
			...
			<div id="contents">
				...
				<c:forEach var="ee" items="${eee}" >
				<div class="card">
			
					<div class="card-header">
						<div class="row">
							
							<div class="col-left">강의명: ${ee.lectureName}&nbsp;</div>
							<div class="col-right">종합:<span style="color:red;"></span></div>
						</div>
							<br>
						<div class="col-leftt"><small>교수: ${ee.professorName}</small></div>
						<div class="col-leftt" style="margin-left:5px;">작성자: ${ee.userID} &nbsp;</div>
						<br>
						<hr>
					</div>
					<div class="card-body">
						<h5 class="card-title">
							제목 : ${ee.evalutionTitle}</small>
						</h5>
						<br>
						<p class="card-text">내용 : ${ee.evalutionContent}</p>
						<hr>
						<div class="row">
							<div class="col-left">
								강의력<span style="color:red;">${ee.lecskill}</span>
								난이도<span style="color:red;">${ee.leclevel}</span>			
							</div>
							<div class="col-text-right">
								<c:url value="/lecture/modify?evalutionID=${ee.evalutionID}" var="url"/><a href="${url}">수정</a>
